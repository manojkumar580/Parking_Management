...
- Create Angular project with ng: `ng new "parking_management.client" --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`parking_management.client.esproj`).
